                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group form-floating-label">
                                ...
                                <label for="category" class="placeholder">STCK_STATUS</label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group form-floating-label">
                            ...
                            <label for="category" class="placeholder">STNK_STATUS</label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group form-floating-label">
                            ...
                            <label for="category" class="placeholder">BPKB_STATUS</label>
                        </div>
                    </div>
