...
<div class="col-md-12" id="dataCreate">
    <div class="card">
        <div class="card-header">
            <span style="background-color: <?php echo $unit->color->color_code ?>;
                                        ...
                                        <div class="col-5">
                                            <div class="icon-big text-center">
                                                <i class="fas fa-motorcycle"
                                                    style="color: <?php echo ($unit->color->color_code == '#FFFFFF') || ($stock->unit->color->color_code == '#ffffff') || ($stock->unit->color->color_code == '#fff') || ($stock->unit->color->color_code == 'white') ? '#000' : $stock->unit->color->color_code ?>;"></i>
                                            </div>
                                        </div>
                                        <div class="col-7 col-stats">
                                            <div class="numbers">
                                                <p class="card-category">Stocks</p>
                                                <h4 class="card-title">{{ $qty }}<span class="card-category">
                                                        Unit(s)</span></h4>
                                            </div>
                                        </div>
                                    </div>
